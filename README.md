...
| yes         | 2.3 | Shading & Materials - Apply Phong shading to all objects.                               | 7           | implemented by adding a material node before every renderNode in the scene graph                                                                                                                                                                                                                                                                                                                                                                                   |
...
| yes         | 3.1 | Animation - Animate camera for exactly 20 seconds.                                      | 14          | camera is rotating in a circle around the setup in the middle starting where the arm is located at the start                                                                                                                                                                                                                                                                                                                                                       |
| yes         | 3.2 | Animation - Animated light - one light source should be moving in the scene.            | 8           | animated a spotlight rotating around the robotic arm, illuminating the tables and the conveyor belt on its way around                                                                                                                                                                                                                                                                                                                                              |
| yes         | 4.1 | Texturing - Texture parts of composed object / set tex coords.                          | 8           | added texturing functionality in the shaders, added CustomTextureNode in main.js to enable/disable texturing uniform in shaders, then textured the robotic arm with 3 different textures.                                                                                                                                                                                                                                                                          |
| yes         | 4.2 | Advanced Texturing - Shadow Mapping or Cube Mapping.                                    | 20          | Cube Mapping: created skybox (industry hall) around the scene, cubemapped this skybox to the conveyor belt via changes in the vertex and fragment shader, and an added class "EnvironmentSGNode" in main.js                                                                                                                                                                                                                                                        |
